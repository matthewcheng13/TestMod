package io.github.testmod.world.entity.monster;
...
public class EnderSlime extends Slime {
    ...
    public EnderSlime(EntityType<? extends io.github.testmod.world.entity.monster.EnderSlime> p_32968_, Level p_32969_) {
    ...
    public static boolean checkEnderSlimeSpawnRules(EntityType<io.github.testmod.world.entity.monster.EnderSlime> p_219003_, LevelAccessor p_219004_, MobSpawnType p_219005_, BlockPos p_219006_, RandomSource p_219007_) {
